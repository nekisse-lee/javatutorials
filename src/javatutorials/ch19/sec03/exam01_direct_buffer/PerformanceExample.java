package javatutorials.ch19.sec03.exam01_direct_buffer;
...
public class PerformanceExample {
    public static void main(String[] args) throws Exception {
        Path from = Paths.get("src/org/opentutorials/javatutorials/ch19/sec03/exam01_direct_buffer/house.jpg");
        Path to1 = Paths.get("src/org/opentutorials/javatutorials/ch19/sec03/exam01_direct_buffer/house2.jpg");
        Path to2 = Paths.get("src/org/opentutorials/javatutorials/ch19/sec03/exam01_direct_buffer/house3.jpg");
